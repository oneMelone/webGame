...
class Player extends GameObject {
    ...
    is_attacked(angle, damage) {
        for (let i = 0; i < 10 + Math.random() * 5; i++) {
            ...
            let move_length = this.radius * Math.random() * 50;
    ...
    update() {
        ...
        if (this.spend_time > 3 && Math.random() < 1 / 300.0 && !this.is_me) {
...
class GamePlayground {
    ...
    get_random_color() {
        let colors = ["#FB966E", "#FFBA84", "#DAC9A6", "#FBE251", "#86C166"];
...
class GameMap extends GameObject {
    ...
    render() {
        this.ctx.fillStyle = "rgba(67, 52, 27)";
